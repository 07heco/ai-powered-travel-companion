...
@RestController
@RequestMapping("/ai")
@Tag(name = "AI服务", description = "提供模拟AI旅行计划和旅游伙伴演示接口")
public class AIController {

    @Resource
    private AIService aiService;

    @Operation(summary = "生成模拟AI旅行计划", description = "根据目的地、日期和偏好生成演示用的模拟AI旅行计划")
    ...
    @Operation(summary = "与模拟旅游伙伴聊天", description = "与演示用的模拟旅游伙伴进行聊天")
